	...
	if admin:
		...
		if op == 1:
			...
			while True:
				...
				print(f"Estoque de '{produtos[index - 1][0]}' atualizado com sucesso!")
			...
			if len(produtos) == 0:
				...
				for produto in produtos:
					print(f"{produto[0]:<13} {produto[1]:<10} {produto[2]:<13}")
		...
		if op == 1:
			...
			while True:
				...
				animal_selecionado = animais[index - 1]
